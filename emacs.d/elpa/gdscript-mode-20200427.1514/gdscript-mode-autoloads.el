...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gdscript-format" '("gdscript-format--format-region")))
...
(autoload 'gdscript-godot--run-command "gdscript-godot" "\
Run a Godot process.
