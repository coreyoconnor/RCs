...
With prefix ARG, enable Magit-Auto-Revert mode if ARG is positive; otherwise, disable it.  If
...
With prefix ARG, enable Magit-Wip-After-Save mode if ARG is positive; otherwise, disable it.  If
called from Lisp, enable the mode if ARG is omitted or nil.
