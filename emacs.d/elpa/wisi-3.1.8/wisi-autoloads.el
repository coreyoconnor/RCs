...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wisi-prj" '("wisi-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wisi-run-indent-test" '("large-frame" "run-test" "save-" "skip-" "test-" "wisi-test-save-log")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wisi-skel" '("wisi-skel-")))
...
(autoload 'wisitoken-parse_table-goto "wisitoken-parse_table-mode" "\
Get symbol at point, goto symbol's definition.
Symbol can be a nonterminal name, or a state number." t nil)

(autoload 'wisitoken-parse_table-conflict-goto "wisitoken-parse_table-mode" "\
...
If called interactively, enable Wisitoken-Parse_Table mode if ARG
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wisitoken-parse_table-mode" '("wisitok")))
