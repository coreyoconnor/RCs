...
(autoload 'create-wisi-prj "wisi-prj" "\


\(fn &key NAME COMPILE-ENV FILE-ENV COMPILER XREF CASE-EXCEPTION-FILES (CASE-FULL-EXCEPTIONS \\='nil) (CASE-PARTIAL-EXCEPTIONS \\='nil) SOURCE-PATH FILE-PRED)" nil nil)

(autoload 'wisi-prj-make-compiler "wisi-prj" "\
...
For `xref-backend-functions'." nil nil)
...
(register-definition-prefixes "wisi-run-indent-test" '("cl-print-readably" "run-test" "save-" "skip-" "test-" "wisi-"))
...
(register-definition-prefixes "wisitoken-parse_table-mode" '("wisitok"))

;;;***

;;;### (autoloads nil nil ("prj-alire.el" "prj-wisi.el" "wisi-pkg.el")
;;;;;;  (0 0 0 0))
